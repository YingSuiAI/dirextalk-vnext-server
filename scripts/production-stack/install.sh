...
install -d -o root -g root -m 0700 /etc/dirextalk/vnext/secrets
install -d -o root -g root -m 0700 /etc/dirextalk/vnext/secrets/role-passwords
install -d -o root -g root -m 0700 /etc/dirextalk/vnext/secrets/agent-control
install -d -o root -g root -m 0755 /etc/dirextalk/vnext/config
install -d -o root -g root -m 0700 /etc/dirextalk/vnext/tls
