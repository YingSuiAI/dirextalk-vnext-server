...
const V22_ARTIFACT_PATHS: &[&str] = &[
    "protocol/cddl/mls-sequencer/v2",
...
const V25_ARTIFACT_PATHS: &[&str] = &[
    "protocol/cddl/indexer/v1",
...
const V27_ARTIFACT_PATHS: &[&str] = &[
    "protocol/cddl/contact-delivery/v1",
...
const V31_ARTIFACT_PATHS: &[&str] = &[
    "protocol/cddl/conversation-agent-grant/v1",
...
const V37_ARTIFACT_PATHS: &[&str] = &[
    "protocol/cddl/realtime-sync/v1",
...
mod tests {
    ...
    fn v36_selects_only_additive_public_discussion_private_v8_and_query_overlay() {
        let v36 = BASELINE_SPECS
            .iter()
            .find(|spec| spec.version == 36)
            .expect("v36 baseline spec");
    ...
    fn v38_selects_only_opaque_account_read_cursor_contracts() {
        let v38 = BASELINE_SPECS
            .iter()
            .find(|spec| spec.version == 38)
            .expect("v38 baseline spec");
