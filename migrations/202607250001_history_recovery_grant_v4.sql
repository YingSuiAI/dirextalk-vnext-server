...
CREATE TABLE messaging.history_recovery_grants_v4 (
    ...
    exact_offer bytea NOT NULL CHECK (octet_length(exact_offer) BETWEEN 1 AND 1049059),
    exact_grant bytea NOT NULL CHECK (octet_length(exact_grant) BETWEEN 1 AND 1050699),
