...
DELETE FROM agent.connector_control_commands
 WHERE command_kind IN ('deliver_agent_provisioning', 'revoke_agent_provisioning');
...
DELETE FROM agent.connector_control_operations
 WHERE operation_kind IN ('deliver_agent_provisioning', 'revoke_agent_provisioning');
