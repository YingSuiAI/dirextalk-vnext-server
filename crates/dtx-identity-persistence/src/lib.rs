...
pub use recovery_scope_catalog::{
    ...
    PREPARATION_DIGEST_DOMAIN, PREPARATION_SIGNATURE_DOMAIN, PROVIDER_CIPHERTEXT_HASH_DOMAIN,
    PROVIDER_RESPONSE_DIGEST_DOMAIN, PROVIDER_RESPONSE_SIGNATURE_DOMAIN, RECIPIENT_KEY_HASH_DOMAIN,
    RESPONSE_CAPABILITY_HASH_DOMAIN, RecoveryResponseCapability, RecoveryScopeCatalogOutcome,
    RecoveryScopeCatalogRepository, RecoveryScopeCatalogStatusOutcome,
};
pub use repository::{
