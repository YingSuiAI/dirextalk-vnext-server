...
define_uuid_v7_id!(MailboxId, "opaque mailbox ID");
define_uuid_v7_id!(EnvelopeId, "opaque mailbox envelope ID");
define_uuid_v7_id!(
...
define_uuid_v7_id!(RouteHealthKeyId, "Agent Route health key ID");
