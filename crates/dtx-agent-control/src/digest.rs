    ...
    fn failed_report_digest_matches_the_frozen_lp_transcript() {
        ...
        assert_eq!(
            run_failed_report_digest(
                ...
                Some((
                    [
                        0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x76, 0x07, 0x88, 0x09, 0x0a, 0x0b,
                        0x0c, 0x0d, 0x0e, 0x0f,
                    ],
                    Sha256Digest::from_bytes([0x55; 32]),
                )),
            ...
            .as_bytes(),
            [
                0x22, 0xe2, 0xb6, 0xb6, 0x49, 0x97, 0xbe, 0x42, 0xc0, 0x80, 0x97, 0x10, 0x64, 0x16,
                0xf2, 0x17, 0xc6, 0xc5, 0x6b, 0xe7, 0xf1, 0x6b, 0xeb, 0xb3, 0x42, 0x39, 0x3f, 0x3f,
                0x56, 0x07, 0x13, 0x11,
            ]
        );
    }
